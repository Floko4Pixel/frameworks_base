...
public class SystemUIApplication extends Application implements SysUiServiceProvider {
    ...
    public void startServicesIfNeeded() {
        ...
        String[] elmyra = getResources().getStringArray(R.array.config_systemUIServiceComponents_elmyra);
        startServicesIfNeeded(!getResources().getBoolean(R.bool.has_elmyra_service) ? names : elmyra);
    }
